...
import { Search, X, ExternalLink, Copy, Check as CheckIcon, Save, MessageSquare } from "lucide-react";
...
function ReviewLinkSection({
  ...
  return (
    <div className="rounded-[10px] border border-[#E8EAF0] overflow-hidden">
      <div className="bg-[#F8F9FC] px-4 py-2.5 border-b border-[#E8EAF0] flex items-center gap-1.5">
        <MessageSquare size={11} className="text-[#6B7399]" />
        <p className="text-[11px] font-semibold text-[#6B7399] uppercase tracking-wide">
          후기 요청 링크
        </p>
      </div>
