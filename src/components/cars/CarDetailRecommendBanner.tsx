...
export function CarDetailRecommendBanner() {
  return (
    <motion.section
      initial={false}
      className="mt-12 overflow-hidden rounded-[24px] bg-brand text-white"
    >
      <div className="grid gap-5 px-6 py-8 md:grid-cols-[1fr_auto] md:items-center md:px-12 md:py-10">
        ...
        <Link
          href="/recommend"
          className="inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-btn bg-white px-6 text-[14px] font-extrabold text-brand transition-colors duration-150 hover:bg-white/90 md:w-auto"
        >
          AI 추천 받기
