        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(420px,0.9fr)] lg:items-center lg:gap-16">
          ...
          <div className="min-w-0">
            ...
            <div className="mt-8 flex flex-col gap-2.5 sm:flex-row sm:items-center">
              ...
              <Link
                href="/cars"
                className="flex h-[56px] w-[180px] items-center justify-center gap-2 rounded-[14px] bg-surface-soft px-3 text-[16px] font-bold text-text-strong ring-[1.5px] ring-brand/30 transition-all hover:ring-brand active:scale-[0.99] max-[340px]:w-full md:text-[17px]"
              >
                내 차량 견적내기
              </Link>
            </div>
