        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(420px,0.9fr)] lg:items-center lg:gap-16">
          ...
          <div className="min-w-0">
            ...
            <div className="mt-8 flex flex-col gap-2.5 sm:flex-row sm:items-center">
              ...
              <Link
                href="/recommend"
                className="flex h-[56px] items-center justify-center gap-2 rounded-[14px] bg-[#F8FAFC] px-7 text-[16px] font-bold text-text-strong ring-[1.5px] ring-transparent transition-all hover:ring-[#E5E8EB] active:scale-[0.99] md:text-[17px]"
              >
                AI 추천 받기
              </Link>
            </div>
