...
export const metadata: Metadata = {
  ...
  description:
    "(주)아임메타솔루션 아임딜러(IM DEALER) 서비스 법적 고지 및 제휴 금융사별 상품 안내",
};
...
const COMMON_NOTICES: string[] = [
  ...
  "(주)아임메타솔루션(아임딜러)은 BNK캐피탈, 하나캐피탈, 롯데캐피탈, NH농협캐피탈, JB우리캐피탈, 우리금융캐피탈, 신한카드, 메리츠캐피탈, 오릭스캐피탈코리아, iM캐피탈, 우리카드, 산은캐피탈, KB캐피탈의 자동차 리스·렌트 등의 상품 판매업무를 대리·중개합니다.",
  "(주)아임메타솔루션(아임딜러)은 제휴 금융회사의 자동차 리스·렌트 상품에 대한 계약 체결 권한이 없습니다.",
  "(주)아임메타솔루션(아임딜러)은 「금융소비자 보호에 관한 법률」에 따라 등록된 금융상품판매대리·중개업자입니다. (등록번호: 기재 예정)",
  "(주)아임메타솔루션(아임딜러)은 서비스 이용과 관련하여 이용자에게 어떠한 금전적 대가도 받지 않으며, 금융회사를 대신하여 보증금, 월 납부금 등 각종 금전을 받지 않습니다.",
  "(주)아임메타솔루션(아임딜러)과 제휴한 각 금융회사가 여신 심사 등을 거쳐 이용자와 직접 계약을 체결하며, 본 서비스를 통해 상품 계약을 체결하는 경우 계약의 주체는 해당 금융회사가 됩니다.",
  ...
  "(주)아임메타솔루션(아임딜러)이 고의 또는 과실로 「금융소비자 보호에 관한 법률」을 위반하여 고객에게 손해를 발생시킨 경우, (주)아임메타솔루션은 그 손해를 배상할 책임이 있습니다. 다만, 고의 및 과실이 없음을 입증할 경우 그러하지 아니합니다.",
];
...
const COMMON_CAUTIONS: string[] = [
  ...
  "(주)아임메타솔루션(아임딜러)은 고객에게 별도의 수수료를 요구하거나 수취하지 않습니다.",
];
