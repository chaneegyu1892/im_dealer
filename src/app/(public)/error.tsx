...
// (public) 세그먼트 에러 바운더리.
// Next 계층상 이 fallback 은 (public)/layout.tsx (Header/Footer/BottomNav) 하위에서
// 렌더되므로, quote/cars/reviews 등에서 throw 가 나도 헤더/풋터가 유지된다.
// (public)/layout.tsx 자체의 에러와 루트 layout 의 에러는 여기가 아니라
// 루트 error.tsx / global-error.tsx 로 버븀업된다.
// 세그먼트 error.tsx 는 같은 경로의 루트 error.tsx 보다 가까운 boundary 로 우선 적용된다.
